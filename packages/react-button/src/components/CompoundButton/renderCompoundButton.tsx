...
import { CompoundButtonState, CompoundButtonSlots } from './CompoundButton.types';
...
export const renderCompoundButton = (state: CompoundButtonState) => {
  const { slots, slotProps } = getSlots<CompoundButtonSlots>(state, compoundButtonShorthandProps);
